...
# BACKGROUND
Indoor and outdoor air pollution has been shown to worsen asthma in individuals that have asthma. There are many factors that can influence asthma severity including air temperature, humidity, wind speed, location, offgassing of building materials, tobacco, smoke from fires, and airborne allergens. Some of the biggest air polluters are particulate matter or small droplets that are less than 2.5 µm in diameter, ozone, nitrogen dioxide, sulfur dioxide, and carbon monoxide.(https://www.aaaai.org/tools-for-the-public/conditions-library/asthma/your-questions-answered-on-air-pollution-and-asthm). Exposure to these pollutants can inflame and irritate the lining and receptors of a person's airways. This can cause symptoms similar to asthma. 
